...
# MAGIC %sh
# MAGIC wget https://tfhub.dev/google/universal-sentence-encoder/4?tf-hub-format=compressed  -P /dbfs/tmp/universal
...
# MAGIC %sh
# MAGIC mv /dbfs/tmp/universal/4?tf-hub-format=compressed /dbfs/tmp/universal/UniversalSentenceEncoder.targ.gz

# COMMAND ----------

# MAGIC %sh
# MAGIC ls -l /dbfs/tmp/universal/

# COMMAND ----------

# MAGIC %sh
# MAGIC gunzip /dbfs/tmp/universal/UniversalSentenceEncoder.targ.gz

# COMMAND ----------

# MAGIC %sh
# MAGIC tar -xvf /dbfs/tmp/universal/UniversalSentenceEncoder.targ -C /dbfs/tmp/universal/
